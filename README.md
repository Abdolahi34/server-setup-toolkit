...
### ۱. گرفتن هش کلید عمومی سرور

اولین اتصال به سرور را از طریق ترمینال سایت ارائه دهنده برقرار کنید. برحسب اینکه به طور معمول از چه ابزاری میخواهید برای اتصال SSH به سرور خود استفاده کنید، باید هش کلید عمومی با فرمت مورد نیاز را دریافت کنید.
...
### ۲. ساخت کلید SSH (در ویندوز یا لینوکس)
...
### ۳. اجرای تنظیمات اولیه (روی سرور)
...
### ۶. اعلان ورود SSH در تلگرام (اختیاری)
